...
ALL_DATA_ROOT='../../data' # Changed my folder structure for minimal code changes.
...
python ../Main/new_train_normal_gnn.py $PROJECT_ROOT --data_root $DATA_ROOT --results_root $RESULTS_ROOT \
    --model "pprgo" --config_file $CONFIG_FILE_ROOT"/common_gnn-config.yaml"  --ppr_data_root $OUTPUT_ROOT"/ppr/undirected-top100" --topk $TOP_K  \
